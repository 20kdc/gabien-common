...
public abstract class UNAABIFinder {
    private static final UNAABI X86_STDCALL = new UNAABIThreefold(UNAInvoke.Mode.x86_stdcall, UNASysTypeInfo.si32, true, false, 0, 0, UNAABIThreefold.FPHandling.FP);
    private static final UNAABI X86_CDECL = new UNAABIThreefold(UNAInvoke.Mode.x86_cdecl, UNASysTypeInfo.si32, true, false, 0, 0, UNAABIThreefold.FPHandling.FP);
    private static final UNAABI X86_64_MS = new UNAABIThreefold(UNAInvoke.Mode.x86_64_windows, UNASysTypeInfo.si64, false, false, 4, 4, UNAABIThreefold.FPHandling.FPGPShadow);
    private static final UNAABI X86_64_UNIX = new UNAABIThreefold(UNAInvoke.Mode.x86_64_unix, UNASysTypeInfo.si64, false, false, 6, 8, UNAABIThreefold.FPHandling.FP);
