...
static BADGPUBool attemptEGL(BADGPUWSICtx ctx, int32_t ctxTypeAttrib, int32_t api, BADGPUContextType ctxTypeBG, const char ** glLocations, const char * glLibraryName, BADGPUBool logDetailed, BADGPUBool tryNoWSI) {
    void * config;
    int32_t attribs[] = {
