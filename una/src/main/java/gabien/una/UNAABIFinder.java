...
public abstract class UNAABIFinder {
    private static final UNAABI X86_STDCALL = new UNAABI(UNAInvoke.Mode.x86_stdcall, true, false, 0, 0, false);
    private static final UNAABI X86_CDECL = new UNAABI(UNAInvoke.Mode.x86_cdecl, true, false, 0, 0, false);
    private static final UNAABI X86_64_MS = new UNAABI(UNAInvoke.Mode.x86_64_windows, false, false, 4, 4, false);
    private static final UNAABI X86_64_UNIX = new UNAABI(UNAInvoke.Mode.x86_64_unix, false, false, 6, 8, false);
