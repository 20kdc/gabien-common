...
patch (name "digital harp"
	sustainEnabled #t noiseEnabled #f strikeMs 100 releaseMs 500 fixedFrequency 0 octaveShift 0
...
patch (name "rounded square"
	sustainEnabled #t noiseEnabled #f strikeMs 200 releaseMs 500 fixedFrequency 0 octaveShift 0
...
patch (name "saw/GFZ2 lead"
	sustainEnabled #t noiseEnabled #f strikeMs 200 releaseMs 100 fixedFrequency 0 octaveShift 0
...
patch (name "y d_bunny 7B"
	sustainEnabled #f noiseEnabled #f strikeMs 100 releaseMs 1 fixedFrequency 0 octaveShift 4
...
patch (name "z perc_bonk_a"
	sustainEnabled #t noiseEnabled #t strikeMs 250 releaseMs 500 fixedFrequency 10 octaveShift 0
	env (0.0 0.0 0.125 0.0 0.2569027543067932 0.11999999731779099 0.23889556527137756 0.4399999976158142 0.3649459779262543 0.0 0.42497000098228455 0.0 0.4981992840766907 0.0 0.5798319578170776 0.0 1.0 0.0)
...
patch (name "z perc_click"
	sustainEnabled #t noiseEnabled #t strikeMs 100 releaseMs 500 fixedFrequency 0 octaveShift 0
	env (0.0 0.0 0.125 0.0 0.25 0.0 0.24943819642066956 0.5199999809265137 0.3224719166755676 0.0 0.4089887738227844 0.0 1.0 0.0)
	wave (0.0 0.5 0.4988763928413391 0.5049999952316284)
	pitchEnv (0.0 0.5)
)
assign 128
